...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Projects\Civ6Amber\UniqueUnit\OutriderHistoricMoment.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>2703784931</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="OutriderHistoricMoment.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="OutriderHistoricMoment"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
