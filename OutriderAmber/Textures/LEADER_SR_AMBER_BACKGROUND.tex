...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Projects\Civ6Amber\Leader\LEADER_SR_AMBER_BACKGROUND.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3042683042</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_SR_AMBER_BACKGROUND.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_SR_AMBER_BACKGROUND"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
